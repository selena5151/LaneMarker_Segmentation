...
class CustomDataset:
    def __init__(self, data_dir, split):
        ...
        self.noword_dir = os.path.join(data_dir, "no_word_label", split)
    ...
    def load_annotations(self):
        ...
        for json_file in json_files:
            ...
            if json_file.endswith(".json"):
                ...
                label_file = os.path.join(self.noword_dir, f"{image_id}_id.png")
...
def register_noword_dataset(name, data_dir, split):
    ...
    'go straight or turn left or right', 'left turn box(car)']
    ...
    colors = [(0, 0, 0), (0, 255, 0), (255, 0, 255), (0, 255, 255), (0, 0, 128), (128, 128, 0), (128, 0, 128), (255, 128, 0),
        ...
        (220, 20, 60), (255, 105, 180), (255, 182, 193), (255, 255, 224), (100, 20, 200)]

    word_label = [1, 3, 4, 7, 8, 9, 13, 15, 16, 17, 21, 24, 26, 28, 29, 
    30, 31, 33, 34, 35, 38, 40, 41, 44, 45, 47, 48, 52, 53, 54, 55, 57, 58, 59, 60, 61, 62, 63]
