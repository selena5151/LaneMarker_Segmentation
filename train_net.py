...
data_dir = "datasets/my_roadmarking"
register_custom_dataset("my_roadmarking_train", data_dir, "train")
register_custom_dataset("my_roadmarking_val", data_dir, "val")

register_singleword_dataset("singleword_roadmarking_train", data_dir, "train")
register_singleword_dataset("singleword_roadmarking_val", data_dir, "val")

register_arrow_dataset("arrow_roadmarking_train", data_dir, "train")
register_arrow_dataset("arrow_roadmarking_val", data_dir, "val")
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if evaluator_type == "custom_semseg":
            assert (
                torch.cuda.device_count() >= comm.get_rank()
        ...
        if evaluator_type == "binary_iou":
            ...
            evaluator_list.append(BinaryIoUEvaluator(dataset_name))
